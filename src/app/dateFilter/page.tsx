          ...
          <div className="flex flex-wrap gap-2 md:gap-4 items-center w-full sm:w-auto">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <button
                ...
                className={`px-3 py-1 md:px-4 md:py-2 rounded-md transition text-white text-sm ${
              ...
              <button
                ...
                className="bg-red-500 text-white px-3 py-1 md:px-4 md:py-2 rounded-md hover:bg-red-600 transition text-sm"
              >
                Logout
              </button>
            </div>
        ...
        <div className="p-6 rounded-b-3xl">
          ...
          {activeTab === 'Performance' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-4">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Conversion Analysis</h3>
                <div className="w-full h-64 sm:h-80"> {/* Increased height to accommodate legend */}
                  <ChartWrapper chartKey="conversion">
                    <ConversionChart data={conversionData} />
                  </ChartWrapper>
                </div>
